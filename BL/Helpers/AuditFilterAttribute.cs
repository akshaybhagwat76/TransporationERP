...
namespace TransportationERP.BL.Helpers
{
    public class AuditFilterAttribute : ActionFilterAttribute
    {
        private readonly IAuditLog _auditRepository;
        private readonly IHttpContextAccessor _httpContextAccessor;
        public AuditFilterAttribute(IHttpContextAccessor httpContextAccessor, IAuditLog auditRepository)
        {
        ...
        {
            var objaudit = new AuditLogs(); // Getting Action Name 
